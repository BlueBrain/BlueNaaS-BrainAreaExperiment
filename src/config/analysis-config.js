...
export default {
  [constants.computers.JURECA]: {
    script: [
      ...
      '/p/project/cvsk25/vsk2512/analysis/analysis_launch_0.7.py --blueconfig ./BlueConfig --output . --analysisconfig ./analysis_config.json -vv',
    ],
  ...
  [constants.computers.PIZ_DAINT]: {
    script: [
      ...
      '/apps/hbp/ich002/home/antonel/analysis_launch_0.7.py --blueconfig ./BlueConfig --output . --analysisconfig ./analysis_config.json -vv',
    ],
    executable: '/bin/bash input.sh',
  },
  [constants.computers.BB5]: {
    script: [
      ...
      'export EMSIM=emsim',
      'python /gpfs/bbp.cscs.ch/home/antonel/scripts_unicore/analysis_launch_0.7.py --blueconfig ./BlueConfig --output . --analysisconfig ./analysis_config.json -vv',
    ],
    executable: '/bin/bash input.sh',
  },
