...
export default {
  [computers.JURECA]: {
    script: [
      ...
      '/p/project/cvsk25/vsk2512/analysis/analysis_launch_jureca_0.13.py --blueconfig ./BlueConfig --output . --analysisconfig ./analysis_config.json -vv',
    ],
  ...
  [computers.PIZ_DAINT]: {
    script: [
      ...
      '/apps/hbp/ich002/home/antonel/analysis_launch_piz_daint_0.13.py --blueconfig ./BlueConfig --output . --analysisconfig ./analysis_config.json -vv',
    ],
    executable: '/bin/bash input.sh',
  ...
  [computers.BB5]: {
    script: [
      ...
      'module load brion',
      'export EMSIM=emsim',
      'python /gpfs/bbp.cscs.ch/home/antonel/scripts_unicore/analysis_launch_bb5_0.13.py --blueconfig ./BlueConfig --output . --analysisconfig ./analysis_config.json -vv',
    ],
    executable: '/bin/bash input.sh',
