...
export default {
  [computers.JURECA]: {
    script: [
      ...
      '/p/project/cvsk25/vsk2512/analysis/analysis_launch_jureca_0.11.py --blueconfig ./BlueConfig --output . --analysisconfig ./analysis_config.json -vv',
    ],
  ...
  [computers.PIZ_DAINT]: {
    script: [
      ...
      '/apps/hbp/ich002/home/antonel/analysis_launch_piz_daint_0.11.py --blueconfig ./BlueConfig --output . --analysisconfig ./analysis_config.json -vv',
    ],
    executable: '/bin/bash input.sh',
