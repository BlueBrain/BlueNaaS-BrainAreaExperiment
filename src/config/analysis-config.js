...
export default {
  JURECA: {
    script: [
      ...
      '/p/project/cvsk25/vsk2512/analysis/analysis_launch_0.3.py --blueconfig ./BlueConfig --output . --analysisconfig ./analysis_config.json -vv',
    ],
  ...
  PIZ_DAINT: {
    script: [
      ...
      '/users/bp000037/analysis/analysis_launch_0.3.py --blueconfig ./BlueConfig --output . --analysisconfig ./analysis_config.json -vv',
    ],
    executable: '/bin/bash input.sh',
  },
  NUVLA: {
